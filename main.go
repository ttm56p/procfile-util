...
func Commands(ctx context.Context, meta command.Meta) map[string]cli.CommandFactory {
	return map[string]cli.CommandFactory{
		...
		"delete": func() (cli.Command, error) {
			return &commands.DeleteCommand{Meta: meta}, nil
		},
		"exists": func() (cli.Command, error) {
			return &commands.ExistsCommand{Meta: meta}, nil
		},
		"expand": func() (cli.Command, error) {
			return &commands.ExpandCommand{Meta: meta}, nil
		},
		...
		"show": func() (cli.Command, error) {
			return &commands.ShowCommand{Meta: meta}, nil
		},
